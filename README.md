...
Cycle and softlock detection mechanisms

CNN-based value network with residual blocks

Custom heuristics for board evaluation

The agent successfully solves small boards and demonstrates promising abstract reasoning behaviour, though medium/hard boards remain challenging.
<br>
